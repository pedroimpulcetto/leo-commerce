...
test('deve ter uma senha de no mínimo 6 digitos', () => {
    let user = new User('Leo', '30/08/1990', 'leo.romanzoti@gmail.com', '300890');
...
test('deve ter uma senha não valida', () => {
    let user = new User('Leo', '30/08/1990', 'leo.romanzoti@gmail.com', '30089');
    let passwordIsValid = user.passwordValidator();
...
test('deve ter mais de 11 anos', () => {
    let user = new User('Leo', '1990-08-30T00:00:00.000', 'leo.romanzoti@gmail.com', '300890');
...
test('deve ter uma data de nascimento inválida', () => {
    let user = new User('Leo', '2013-08-30T00:00:00.000', 'leo.romanzoti@gmail.com', '300890');
